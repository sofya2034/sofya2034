<!--
### Меня зовут Софья, я QA Инженер!</h3>
-->
## Привет! 👋🏼
...
### Меня зовут Софья, я QA Инженер!
- 👩🏼‍💻 **Начинающий специалист** в области функционального тестирования с сильной мотивацией к профессиональному развитию.</br>
- 📚 **Изучила** методологии и инструменты тестирования для того чтобы применять их на практике.</br>
- 🎯 Моя цель - **стать высококлассным QA-специалистом**, который вносит значимый вклад в **обеспечение безупречного качества продукта и его развитие**.</br>
- 🫱🏼‍🫲🏻 **Открыта к сотрудничеству** и стремлюсь присоединиться к сильной команде высококвалифицированных специалистов для работы над инновационными проектами.</br>
